...
e.put("directives/decorators/bootstrap/table/uploadpics.html",'<div class="form-group schema-form-{{form.type}} {{form.htmlClass}}" ng-init="form.options.resultKey=\'url\' ; form.options.progressKey=\'progress\' ; form.options.errorMsgKey=\'errorMsg\'" ng-class="{\'has-error\': form.disableErrorState !== true && hasError(), \'has-success\': form.disableSuccessState !== true && hasSuccess(), \'has-feedback\': form.feedback !== false }"><label class="control-label {{form.labelHtmlClass}}" ng-class="{\'sr-only\': !showTitle(), \'schema-form-required\': form.inputrequired === true}" for="{{form.key.slice(-1)[0]}}">{{form.title}}<span ng-if="form.inputrequired === true" class="join-required"></span></label><div class="joininputcol" ng-class="form.fieldHtmlClass"><div ng-repeat="f in $$value$$ track by $index"><span ng-if="$files[$index][form.options.errorMsgKey]" class="sr-only">错误: {{$files[$index][form.options.errorMsgKey]}}</span> <a ng-if="form.options.showThumb" href="{{f}}" target="_blank"><img ngf-src="f" height="{{form.options.thumbSize}}px" width="{{form.options.thumbSize}}px" style="margin-bottom: 2px" class="thumb"></a> <span class="file-progress" ng-show="$files[$index][form.options.progressKey] >= 0"><div style="width:{{$files[$index][form.options.progressKey]}}%" ng-bind="$files[$index][form.options.progressKey] + \'%\'"></div></span><div ng-show="f" class="glyphicon glyphicon-remove-sign file-del" ng-click="form.options.deleteFn($$value$$, f)"></div></div><a ngf-multiple="true" class="btn btn-success" ngf-select="" ngf-change="form.options.uploadPics($files, form.options, $$value$$, $newFiles, $duplicateFiles, $invalidFiles, $event)" ng-init="form.options.init($files, $$value$$);" ngf-fix-orientation="true" ngf-validate="form.options.uploadvalidate" ngf-resize="{width: (form.options.resizewidth?form.options.resizewidth:960), quality: 0.8, type: \'image/jpeg\', restoreExif: true}" ngf-resize-if="$width > (form.options.resizewidth?form.options.resizewidth:960) || $height > (form.options.resizewidth?form.options.resizewidth:960)" ng-class="form.class" tabindex="-1"><span>批量上传</span></a><br ng-if="form.options.suggestBottom"><span ng-if="form.options.suggestlabel" ng-style="{\'padding-left\': (form.options.suggestBottom? \'0px\' : \'10px\')}" ng-bind="form.options.suggestlabel"></span><div class="help-block" sf-message="form.description"></div></div></div>')}]),angular.module("schemaForm").config(["schemaFormProvider","schemaFormDecoratorsProvider","sfPathProvider",function(e,t,o){var s="directives/decorators/bootstrap/table/",r=function(t,s,r){if("array"===s.type&&"table"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="table",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(r),t.addMapping("bootstrapDecorator","table",s+"table.html"),t.createDirective("table",s+"table.html");var a=function(t,s,r){if("array"===s.type&&"table-title"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="table-title",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(a),t.addMapping("bootstrapDecorator","table-title",s+"table-title.html"),t.createDirective("table-title",s+"table-title.html");var l=function(t,s,r){if("default"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="default",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(l),t.addMapping("bootstrapDecorator","default",s+"mos-default.html"),t.createDirective("default",s+"mos-default.html");var i=function(t,s,r){if("multi-select"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="multi-select",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(i),t.addMapping("bootstrapDecorator","multi-select",s+"mos-multiselect.html"),t.createDirective("multi-select",s+"mos-multiselect.html");var n=function(t,s,r){if("button-group"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="button-group",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(n),t.addMapping("bootstrapDecorator","button-group",s+"mos-button-group.html"),t.createDirective("button-group",s+"mos-button-group.html");var m=function(t,s,r){if("mos-array"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-array",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(m),t.addMapping("bootstrapDecorator","mos-array",s+"mos-array.html"),t.createDirective("mos-array",s+"mos-array.html");var c=function(t,s,r){if("mos-color"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-color",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(c),t.addMapping("bootstrapDecorator","mos-color",s+"mos-color.html"),t.createDirective("mos-color",s+"mos-color.html");var d=function(t,s,r){if("mos-textarea"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-textarea",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(d),t.addMapping("bootstrapDecorator","mos-textarea",s+"mos-textarea.html"),t.createDirective("mos-textarea",s+"mos-textarea.html");var p=function(t,s,r){if("mos-select2"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-select2",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(p),t.addMapping("bootstrapDecorator","mos-select2",s+"mos-select2.html"),t.createDirective("mos-select2",s+"mos-select2.html");var f=function(t,s,r){if("mos-multiselect2"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-multiselect2",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(f),t.addMapping("bootstrapDecorator","mos-multiselect2",s+"mos-multiselect2.html"),t.createDirective("mos-multiselect2",s+"mos-multiselect2.html");var u=function(t,s,r){if("mos-treeselect2"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-treeselect2",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(u),t.addMapping("bootstrapDecorator","mos-treeselect2",s+"mos-treeselect2.html"),t.createDirective("mos-treeselect2",s+"mos-treeselect2.html");var g=function(t,s,r){if("mos-treemultiselect2"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-treemultiselect2",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(g),t.addMapping("bootstrapDecorator","mos-treemultiselect2",s+"mos-treemultiselect2.html"),t.createDirective("mos-treemultiselect2",s+"mos-treemultiselect2.html");var h=function(t,s,r){if("mos-template"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-template",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(h),t.addMapping("bootstrapDecorator","mos-template","directives/decorators/bootstrap/table/mos-template.html"),t.createDirective("mos-template","directives/decorators/bootstrap/table/mos-template.html");var b=function(t,s,r){if("uploadpic"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="uploadpic",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(b),t.addMapping("bootstrapDecorator","uploadpic",s+"uploadpic.html"),t.createDirective("uploadpic",s+"uploadpic.html");var v=function(t,s,r){if("uploadpics"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="uploadpics",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(v),t.addMapping("bootstrapDecorator","uploadpics",s+"uploadpics.html"),t.createDirective("uploadpics",s+"uploadpics.html");var $=function(t,s,r){if("cutuploadpic"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="cutuploadpic",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift($),t.addMapping("bootstrapDecorator","cutuploadpic",s+"cutuploadpic.html"),t.createDirective("cutuploadpic",s+"cutuploadpic.html");var y=function(t,s,r){if("cutuploadpics"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="cutuploadpics",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(y),t.addMapping("bootstrapDecorator","cutuploadpics",s+"cutuploadpics.html"),t.createDirective("cutuploadpics",s+"cutuploadpics.html");var k=function(t,s,r){if("uploadfile"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="uploadfile",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(k),t.addMapping("bootstrapDecorator","uploadfile",s+"uploadfile.html"),t.createDirective("uploadfile",s+"uploadfile.html");var w=function(t,s,r){if("uploadfiles"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="uploadfiles",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(w),t.addMapping("bootstrapDecorator","uploadfiles",s+"uploadfiles.html"),t.createDirective("uploadfiles",s+"uploadfiles.html");var x=function(t,s,r){if("ckeditor"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="ckeditor",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(x),t.addMapping("bootstrapDecorator","ckeditor",s+"ckeditor.html"),t.createDirective("ckeditor",s+"ckeditor.html");var S=function(t,s,r){if("ngtree"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="ngtree",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(S),t.addMapping("bootstrapDecorator","ngtree",s+"ngtree.html"),t.createDirective("ngtree",s+"ngtree.html");var C=function(t,s,r){if("popover-tree"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="popover-tree",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(C),t.addMapping("bootstrapDecorator","popover-tree",s+"popover-tree.html"),t.createDirective("popover-tree",s+"popover-tree.html");var _=function(t,s,r){if("date-range"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="date-range",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(_),t.addMapping("bootstrapDecorator","date-range",s+"date-range.html"),t.createDirective("date-range",s+"date-range.html");var O=function(t,s,r){if("mos-radio-buttons"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-radio-buttons",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(O),t.addMapping("bootstrapDecorator","mos-radio-buttons",s+"mos-radio-buttons.html"),t.createDirective("mos-radio-buttons",s+"mos-radio-buttons.html");var D=function(t,s,r){if("popoverUser"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="popoverUser",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(D),t.addMapping("bootstrapDecorator","popoverUser",s+"popover-user.html"),t.createDirective("popoverUser",s+"popover-user.html");var j=function(t,s,r){if("mos-commit-info"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-commit-info",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(j),t.addMapping("bootstrapDecorator","mos-commit-info",s+"mos-commit-info.html"),t.createDirective("mos-commit-info",s+"mos-commit-info.html");var q=function(t,s,r){if("mos-tree-grid"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-tree-grid",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(q),t.addMapping("bootstrapDecorator","mos-tree-grid",s+"mos-tree-grid.html"),t.createDirective("mos-tree-grid",s+"mos-tree-grid.html");var M=function(t,s,r){if("mos-radios"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="mos-radios",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(M),t.addMapping("bootstrapDecorator","mos-radios",s+"mos-radios.html"),t.createDirective("mos-radios",s+"mos-radios.html");var I=function(t,s,r){if("bs-table"===s.format){var a=e.stdFormObj(t,s,r);return a.key=r.path,a.type="bs-table",r.lookup[o.stringify(r.path)]=a,a}};e.defaults.string.unshift(I),t.addMapping("bootstrapDecorator","bs-table",s+"bs-table.html"),t.createDirective("bs-table",s+"bs-table.html"),t.createDirectives({"mos-number":s+"mos-default.html",text:s+"mos-default.html",date:s+"mos-default.html",password:s+"mos-default.html",input:s+"mos-default.html","multi-select":s+"mos-multiselect.html","table-title":s+"table-title.html",table:s+"table.html","button-group":s+"mos-button-group.html","mos-array":s+"mos-array.html","mos-color":s+"mos-color.html","mos-textarea":s+"mos-textarea.html","mos-commit-info":s+"mos-commit-info.html","mos-select2":s+"mos-select2.html","mos-multiselect2":s+"mos-multiselect2.html","mos-treeselect2":s+"mos-treeselect2.html","mos-treemultiselect2":s+"mos-treemultiselect2.html","mos-template":s+"mos-template.html",uploadpic:s+"uploadpic.html",uploadpics:s+"uploadpics.html",cutuploadpic:s+"cutuploadpic.html",cutuploadpics:s+"cutuploadpics.html",uploadfile:s+"uploadfile.html",uploadfiles:s+"uploadfiles.html",ckeditor:s+"ckeditor.html",ngtree:s+"ngtree.html","popover-tree":s+"popover-tree.html","date-range":s+"date-range.html","mos-radio-buttons":s+"mos-radio-buttons.html","mos-tree-grid":s+"mos-tree-grid.html",popoverUser:s+"popover-user.html","mos-radios":s+"mos-radios.html","bs-table":s+"bs-table.html",label:s+"mos-default.html"})}]);